...
import m_0000_wandering_bushwacker from "../drizzle/0000_wandering_bushwacker.sql" with { type: "text" };
import m_0001_mature_sway from "../drizzle/0001_mature_sway.sql" with { type: "text" };

/** tag+".sql" → raw SQL text (compiled into the binary). */
const files: Record<string, string> = {
  "0000_wandering_bushwacker.sql": m_0000_wandering_bushwacker,
  "0001_mature_sway.sql": m_0001_mature_sway,
};
